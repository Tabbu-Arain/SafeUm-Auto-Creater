...
to(
f"\033[31;m Script Type ➨ \033[1;36m SafeUm Login Auto Creater \n\033[1;31m Github ➨ \033[1;33m Tabbu-Arain\n\033[31;m Creater ➨ \033[1;33m MD Tabassum \n\033[31;m Version ➨ \033[1;33m 2.0\n\033[31;m Tool ➨ \033[1;33m Free \n\033[31;m Time ➨ \033[1;33m Unlimited\n\033[31;m")
print('')
print('\033[32;m')
webbrowser.open("https://www.facebook.com/TabbuArain")
...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            with open('Tabbu-Safeum-Login.txt', 'a') as f:
                f.write(username + ":mmmm | TA : @Tabassum\n")
